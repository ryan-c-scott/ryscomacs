;;; rysco-city-lights-theme.el --- inspired by Atom's City Lights theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup rysco-city-lights-theme nil
  "Options for the `rysco-city-lights' theme."
  :group 'doom-themes)

(defcustom rysco-city-lights-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'rysco-city-lights-theme
  :type 'boolean)

(defcustom rysco-city-lights-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'rysco-city-lights-theme
  :type 'boolean)

(defcustom rysco-city-lights-comment-bg rysco-city-lights-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'rysco-city-lights-theme
  :type 'boolean)

(defcustom rysco-city-lights-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme rysco-city-lights
  ...
  ((bg         '("#1D252C" nil       nil            ))
   ...
   (selection      base0)
   (builtin        blue)
   (comments       (if rysco-city-lights-brighter-comments dark-cyan grey))
   (doc-comments   (doom-lighten (if rysco-city-lights-brighter-comments dark-cyan grey) 0.25))
   (constants      magenta)
   (functions      teal)
   (keywords       blue)
   (methods        cyan)
   ...
   (-modeline-bright rysco-city-lights-brighter-modeline)
   (-modeline-pad
    (when rysco-city-lights-padded-modeline
      (if (integerp rysco-city-lights-padded-modeline) rysco-city-lights-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base4)
   ...
   ((font-lock-comment-face &override)
    :background (if rysco-city-lights-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (mode-line
...
;;; rysco-city-lights-theme.el ends here
