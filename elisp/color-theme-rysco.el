...
(defun color-theme-rysco ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (default ((t (:stipple nil :background "Grey5" :foreground "Grey" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 87 :width semi-condensed :family "misc-fixed"))))
     ...
     (font-lock-keyword-face ((t (:bold t :foreground "medium violet red" :weight bold))))
     ...
     (hg-graph-log-branch-1 ((t (:background nil :foreground "DarkMagenta"))))
     (hg-graph-log-branch-2 ((t (:background nil :foreground "DarkCyan"))))
     (hg-graph-log-branch-3 ((t (:background nil :foreground "LightGreen"))))
     (hg-graph-log-branch-4 ((t (:background nil :foreground "goldenrod2"))))
     (hg-graph-log-branch-5 ((t (:background nil :foreground "salmon"))))
     (hg-graph-log-branch-6 ((t (:background nil :foreground "orchid"))))
     (hg-graph-log-summary ((t (:background nil :foreground "Gray100" :slant italic))))
